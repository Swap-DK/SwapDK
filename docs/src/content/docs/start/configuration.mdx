...
Get your project ID at [cloud.walletconnect.com](https://example.com)
### Blockchair API Key
...
Without this key, UTXO chain functionality is limited. Get your key at [blockchair.com/api](https://example.com)
## RPC URLs
...
SKConfig.setRpcUrl(Chain.Kujira, 'https://example.com');
    ```
